...
//               <div className="space-y-5">
//                 <h1 className="text-4xl font-black tracking-tight sm:text-5xl lg:text-6xl">
//                   Grow Your Business with the <span className="text-[#2DD4BF]">AbheePay Partner Program</span>
//                 </h1>
//                 <p className="max-w-2xl text-base font-semibold text-teal-100 sm:text-lg">
...
//                 <Link
//                   to="/contact"
//                   className="inline-flex items-center justify-center rounded-full border border-white/20 bg-white/10 px-7 py-3.5 text-sm font-semibold text-white transition hover:border-teal-300/40 hover:bg-white/15"
//                 >
//                   Contact Sales
//                 </Link>
//               </div>
...
//                 <Link
//                   to="/contact"
//                   className="inline-flex items-center gap-2 rounded-full border border-white/20 px-7 py-3.5 text-sm font-semibold text-white transition hover:border-teal-300/40 hover:bg-white/10"
//                 >
