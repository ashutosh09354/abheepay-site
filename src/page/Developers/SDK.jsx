...
// import { Code2, Layers, Smartphone, Download } from 'lucide-react';

// const SDK = () => {
//   const cards = [
//     {
//       title: 'Node.js SDK',
//       description: 'Quickly integrate server-side payments with our official Node.js library.',
//       icon: Code2,
//     },
//     {
//       title: 'Python SDK',
//       description: 'Use Python helpers for authentication, request signing, and response parsing.',
//       icon: Layers,
//     },
//     {
//       title: 'Mobile SDKs',
//       description: 'Build native checkout experiences for Android and iOS with a single backend.',
//       icon: Smartphone,
//     },
//     {
//       title: 'Client Libraries',
//       description: 'Support for frontend and backend platforms that simplify integration.',
//       icon: Download,
//     },
//   ];
...
//                 SDKs built for fast AbheePay integrations.
//               </h1>
//               <p className="text-base leading-8 text-slate-600 sm:text-lg">
//                 Choose the right SDK for your stack and get production-ready payment flows running in minutes.
//               </p>
...
//           <h2 className="text-2xl font-bold text-slate-900">Why use AbheePay SDKs?</h2>
//           <div className="mt-8 grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
//             <div className="rounded-3xl bg-[#F8FEFF] p-6">
//               <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#0F5562]">Faster setup</p>
//               <p className="mt-4 text-sm leading-7 text-slate-600">Install, configure, and send your first request with prebuilt helpers.</p>
//             </div>
//             <div className="rounded-3xl bg-[#F8FEFF] p-6">
//               <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#0F5562]">Secure defaults</p>
//               <p className="mt-4 text-sm leading-7 text-slate-600">Built-in key management, validation, and signature support.</p>
//             </div>
//             <div className="rounded-3xl bg-[#F8FEFF] p-6">
//               <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#0F5562]">Cross-platform</p>
//               <p className="mt-4 text-sm leading-7 text-slate-600">Use the same API patterns across web, server, and mobile stacks.</p>
//             </div>
//             <div className="rounded-3xl bg-[#F8FEFF] p-6">
//               <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#0F5562]">Reliable updates</p>
//               <p className="mt-4 text-sm leading-7 text-slate-600">Stay current with SDK releases, changelogs, and developer notes.</p>
//             </div>
//           </div>
//         </div>
//       </section>
