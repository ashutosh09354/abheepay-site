    ...
    <section className="bg-white py-10 px-5 sm:px-8 md:px-12 lg:px-20 font-sans">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10 md:gap-12 lg:gap-16">
        ...
        <div className="relative w-full lg:w-1/2 flex justify-center">
          <div className="relative w-64 h-64 xs:w-72 xs:h-72 sm:w-80 sm:h-80 md:w-[420px] md:h-[420px] lg:w-[350px] lg:h-[350px]">
            ...
            <div
              className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 
                ...
                w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-18 lg:h-18 
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left mt-2 lg:mt-0">
          <h2 className="text-2xl md:text-3xl xs:text-2 font-bold text-gray-900 mb-5">
            About Us
          </h2>
          <p className="text-gray-700 text-base sm:text-xs leading-relaxed mb-6 sm:mb-8 px-2 sm:px-0">
          ...
          <Link to="/about">
            <button
              className="bg-[#2DD4BF] text-white font-small 
                py-1.5 px-8 sm:py-1.5 sm:px-5 
