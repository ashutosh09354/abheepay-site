...
const BlogSection = () => {
  ...
  return (
    <section className="bg-white py-6 px-4 font-sans">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-4 gap-2">
          ...
          <div className="flex gap-1.5">
            <button
              ref={prevRef}
              className="bg-white p-1.5 rounded-full hover:bg-[#2DD4BF] hover:text-white transition-all duration-300 shadow-sm border border-gray-200"
            >
        ...
        >
          {blogs.map((blog) => (
            <SwiperSlide key={blog.id}>
              <div className="max-w-[300px] mx-auto bg-white rounded-lg overflow-hidden shadow-[0_1px_10px_rgba(0,0,0,0.08)] border border-gray-100 h-full flex flex-col group cursor-pointer hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] transition-shadow duration-300">
                ...
                <div className="relative h-[100px] overflow-hidden">
                  ...
                  />
                  <span className="absolute top-2 left-2 bg-[#2DD4BF] text-white text-[8px] px-1.5 py-0.5 rounded font-semibold tracking-wide">
                    {blog.author}
                  </span>
                </div>
                ...
                <div className="p-3 flex flex-col flex-1">
                  <h3 className="text-[#1a1a2e] text-xs font-bold leading-snug mb-2 flex-1 group-hover:text-[#2DD4BF] transition-colors duration-300">
                    {blog.title}
                  </h3>

                  <div className="flex items-center gap-1.5 mb-2">
                    <div className="w-5 h-5 rounded-full bg-[#3b4b94] text-white flex items-center justify-center text-[8px] font-bold flex-shrink-0">
                      {getInitials(blog.author)}
                    </div>
                    <div className="leading-tight">
                      <p className="text-[10px] font-semibold text-[#1a1a2e]">{blog.author}</p>
                      <p className="text-[9px] text-gray-400">{blog.date}</p>
                    </div>
                  </div>

                  <a
                    href={blog.url}
                    className="text-[#2DD4BF] text-[10px] font-semibold no-underline hover:underline inline-flex items-center gap-1 w-fit"
                  >
                    Read More
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:translate-x-0.5 transition-transform duration-300">
