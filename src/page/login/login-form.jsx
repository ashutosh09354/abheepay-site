        ...
        <div className="relative w-full md:w-[40%] bg-black overflow-hidden flex flex-col justify-center items-center">
          ...
          <div className="relative z-10 flex flex-col items-end w-full pr-0">
            ...
            <button
              ...
              className="mt-6 text-white font-semibold pr-10"
            >
                ...
                <>
                  ...
                  <div className="flex justify-between pt-1">
                    <button
                      ...
                      className="text-[#00D2CC] text-sm"
                    >
                      Back to Login
                    </button>

                    <button className="bg-gradient-to-r from-[#00D2CC] to-black text-white px-8 py-2 rounded-full">
                      Reset
                    </button>
                  </div>
                </>
